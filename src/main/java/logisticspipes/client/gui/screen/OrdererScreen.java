...
public abstract class OrdererScreen<T extends OrdererMenu> extends LogisticsBaseGuiScreen<T>
    implements IItemSearch, ISpecialItemRenderer, IAvailableItemsReceiver {
    ...
    public void init() {
        ...
        popupCheck = new GuiCheckBox(8, leftPos + 9, bottom - 60, 14, 14,
        ...
        if (itemDisplay == null) {
            itemDisplay = new ItemDisplay(this, font, this, this, leftPos + 10, topPos + 18, panelWidth - 20,
                panelHeight - 100, xCenter, bottom - 24, 49, new int[] { 1, 10, 64, 64 }, true);
        }
