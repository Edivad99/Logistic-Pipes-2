...
public class InvSysConnectorScreen extends LogisticsBaseGuiScreen<InvSysConMenu>
    ...
    public InvSysConnectorScreen(InvSysConMenu menu, Inventory inventory, Component title) {
    ...
    public void init() {
        ...
        b3.setPressListener(b -> resistanceCountBar.setInteger(
            resistanceCountBar.getInteger() - (Minecraft.getInstance().hasControlDown() ? 10 : 1)));
        ...
        if (this.resistanceCountBar == null) {
            this.resistanceCountBar = new InputBar(this.font, this, leftPos + 90, topPos + 55, 30, 12, false, true,
                InputBar.Align.CENTER);
    ...
    public void handleChannelInformation(ChannelInformation channel, boolean flag) {
        if (flag) {
            ...
            .equals(channel.getChannelIdentifier())) {
            this.connectedChannel = channel;
        }
    }
}
