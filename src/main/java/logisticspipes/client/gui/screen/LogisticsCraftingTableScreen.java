...
public class LogisticsCraftingTableScreen extends LogisticsBaseGuiScreen<AutoCraftingMenu> {
    ...
    public LogisticsCraftingTableScreen(AutoCraftingMenu menu, Inventory inventory, Component title) {
    ...
    protected void extractGuiBackground(GuiGraphicsExtractor guiGraphics, int iA, int jA, float fA) {
        ...
        ItemStackRenderer.renderItemIdentifierStackListIntoGui(guiGraphics, Arrays.asList(items), null, 0, leftPos + 8,
            topPos + 79, 9, 9, 18, 18, 0.0F, DisplayAmount.NEVER);
