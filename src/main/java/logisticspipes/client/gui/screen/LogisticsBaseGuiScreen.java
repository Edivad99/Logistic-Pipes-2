...
public abstract class LogisticsBaseGuiScreen<T extends AbstractContainerMenu>
    ...
    public LogisticsBaseGuiScreen(T container, Inventory inventory, Component title,
    ...
    public LogisticsBaseGuiScreen(T container, int panelWidth, int panelHeight, int xCenterOffset,
        int yCenterOffset) {
        super(container, Minecraft.getInstance().player.getInventory(), Component.empty());
        this.panelWidth = panelWidth;
        this.panelHeight = panelHeight;
    ...
    public <W extends AbstractWidget> W addRenderableWidget(W button) {
